...
% variable
% TODO
\newcommand{\pdfauthor}{Mike Chyson}
\newcommand{\pdftitle}{}
\newcommand{\pdfsubject}{}
\newcommand{\pdfkeywords}{python3}
\newcommand{\bookname}{Python 3}
\newcommand{\bookoneword}{Notebook on programming in python 3}
\newcommand{\timeandcompany}{Jan, 15, 2021}
